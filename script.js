...
function detectCategory(title) {
  ...
  if (t.includes('กลางภาค') || t.includes('midterm') || t.includes('mid') || t.includes('สอบกลาง')) return 'กลางภาค';
  if (t.includes('หลังกลางภาค') || t.includes('after')) return 'หลังกลางภาค';
  return 'ก่อนกลางภาค';
}
